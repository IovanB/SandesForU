...
namespace SandesForU.Areas.Admin.Controllers
{
    [Area("Admin")]
    [Authorize("Admin")]
    public class AdminImagesController : Controller
    {
        ...
        public AdminImagesController(IOptions<ConfigurationImages> configurationImages, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult Deletefile(string fname)
        {
            string _imagemDeleta = Path.Combine(_webHostEnvironment.WebRootPath,
                configurationImages.NomePastaImagensProdutos + "\\", fname);
